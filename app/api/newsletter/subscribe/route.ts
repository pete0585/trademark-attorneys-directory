...
const NICHE = 'trademark' as const
const DIRECTORY_SLUG = 'trademark-attorneys-directory' as const
const NEWSLETTER_NAME = 'The Name & Claim Letter' as const
const CONFIRM_URL_BASE = 'https://www.findtrademarkattorney.com/newsletter/confirm'
